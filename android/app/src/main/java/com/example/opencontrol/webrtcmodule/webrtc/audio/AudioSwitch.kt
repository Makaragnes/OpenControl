...
package com.example.opencontrol.webrtcmodule.webrtc.audio

import android.content.Context
import android.media.AudioManager
import com.example.opencontrol.webrtcmodule.webrtc.audio.AudioDevice.Earpiece
import com.example.opencontrol.webrtcmodule.webrtc.audio.AudioSwitch.State.ACTIVATED
...
class AudioSwitch internal constructor(
  ...
  private fun activate(audioDevice: AudioDevice) {
    ...
    when (audioDevice) {
      ...
      is Earpiece, is AudioDevice.WiredHeadset -> audioManager.enableSpeakerphone(false)
